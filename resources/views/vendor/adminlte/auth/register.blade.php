        ...
        <h4>Registro de psicólogos</h4>
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="psicologos" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" required name="personal_phone" class="form-control @error('personal_phone') is-invalid @enderror" value="{{ old('personal_phone') }}" placeholder="Personal Phone">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" required name="bussiness_phone" class="form-control @error('bussiness_phone') is-invalid @enderror" value="{{ old('bussiness_phone') }}" placeholder="Bussiness Phone">
                    ...
                    {{-- Specialty field --}}
                    <div class="input-group mb-3">
                        <input type="text" required name="specialty" class="form-control @error('specialty') is-invalid @enderror" value="{{ old('specialty') }}" placeholder="Especialidad" >

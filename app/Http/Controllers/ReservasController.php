...
//dd("pasa por aqio?");
                ...
                Reservations::create([
                    ...
                    'id_user'           => User::where('email',$request->email)->latest()->first()->id,
                ...
                $notificar= new ArmarNotificacion();
                $notificar->enviarNotification($request->link_meeting, $request->appointment_date);
